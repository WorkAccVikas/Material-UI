...
/** DESCRIPTION : This code implements a checkbox Autocomplete component with a "Select All" option. It also displays limits the number of selected options to 2. */
